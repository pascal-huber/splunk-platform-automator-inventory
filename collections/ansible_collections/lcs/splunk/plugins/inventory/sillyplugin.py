...
# source: https://raw.githubusercontent.com/ansible/ansible/devel/lib/ansible/plugins/inventory/yaml.py
# 
# I removed one exception to allow specifying this plugin inside the yml inventory
...
class InventoryModule(BaseFileInventoryPlugin):
    ...
    def parse(self, inventory, loader, path, cache=True):
        ...
        # NOTE: allow specifying this yaml plugin inside the yaml inventory, duh
